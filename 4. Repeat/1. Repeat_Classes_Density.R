rep_classes = read.table("repeat_classes_two.txt")
...
repeats = read.table("repeatmasker_1")
...
cnvs = density_function(cnvs, SINE_MIR_reps,"SINE/MIR",7)
cnvs = density_function(cnvs, SINE_tRNA_reps,"SINE/tRNA",8)
cnvs = density_function(cnvs, SINE_Alu_reps,"SINE/Alu",9)
cnvs = density_function(cnvs, LINE_Dong_reps,"SINE/Dong",10)
cnvs = density_function(cnvs, LINE_L2_reps,"LINE/L2",11)
cnvs = density_function(cnvs, LINE_CR1_reps,"LINE/CR1",12)
cnvs = density_function(cnvs, LINE_L1_reps,"LINE/L1",13)
cnvs = density_function(cnvs, LTR_ERVK_reps,"LTR/ERVK",14)
cnvs = density_function(cnvs, LTR_ER1_reps,"LTR/ER1",15)
cnvs = density_function(cnvs, LTR_ERVL_reps,"LTR/ERVL",16)
cnvs = density_function(cnvs, LTR_Gypsy_reps,"LTR/Gypsy",17)
cnvs = density_function(cnvs, RC_Helitron_reps,"RC/Helitron",18)
cnvs = density_function(cnvs, DNA_TcMar_reps,"DNA/TcMar",19)
cnvs = density_function(cnvs, DNA_PiggyBac_reps,"DNA/PiggyBac",20)
cnvs = density_function(cnvs, DNA_hAT_reps,"DNA/hAT",21)
cnvs = density_function(cnvs, Simple_repeats_reps,"Simple_repeats",22)
cnvs = density_function(cnvs, Low_complexity_reps,"Low_Complexity",23)



write.csv(cnvs,"cnvs_repeat_class.csv", row.names = FALSE)
