...
```{r}
cnvs_total_mods = read.csv("cnvs_total_mod.csv")
```


```{r}
cnvs_all = cnvs_total_mods[,c(5,7:45)]
model_first <- glm(cohort ~.,family=binomial,data=cnvs_all)
summary(model_first)
```
```{r}
cnvs_all = cnvs_total_mods[,c(5,7,10,17,20,21,23,24,29,31,33,35,38,41)]
model_first <- glm(cohort ~.,family=binomial,data=cnvs_all)
summary(model_first)
```

```{r}
data_select = cnvs_total_mods[,c(5,7,10,17,20,21,23,24,29,31,33,35,38,41)]
